...
const generateAddress = (username, repoName) =>
  `direct:https://github.com/${username}/${repoName}/archive/refs/heads/main.zip`;
 ...
 *
 * Note: https://www.npmjs.com/package/download-git-repo#direct
 * Because the github address config is changed, the address need to
 * be formatted to a direct address:
 * https://github.com/niexia/issues-blog-template/archive/refs/heads/main.zip
 */
function formatGitRepoAddress(gitRepoAddress) {
  ...
  if (httpsRegexp.test(gitRepoAddress)) {
